...
//Vehicle Exit and Payment Panel
...
public class ExitPanel extends JPanel {
    ...
    private void addReceiptRow(JPanel p, String title, JLabel val, int row, GridBagConstraints g, Font f) {
        ...
        // Column 2: Invisible glue column that fills all right-side space
    ...
    private void setupEvents() {
        ...
        btnPay.addActionListener(e -> {
            ...
            DataCenter.addPayment(new Payment(plate, currentTotal, comboPayment.getSelectedItem().toString()));
            
            // 3. Update system: remove vehicle and clear fines 
